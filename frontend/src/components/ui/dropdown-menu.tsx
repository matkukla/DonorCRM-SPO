...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-[8rem] max-h-[min(var(--radix-dropdown-menu-content-available-height,300px),300px)] overflow-y-auto rounded-lg border bg-popover p-1 text-popover-foreground shadow-md",
