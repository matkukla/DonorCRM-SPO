...
from apps.gifts.export_views import (
    GiftExportCSVView,
    RecurringGiftExportCSVView,
)
...
urlpatterns = [
    ...
    path('recurring/export/csv/', RecurringGiftExportCSVView.as_view(), name='recurring-gift-export-csv'),
